...
function abcfsl_mbox_tplate_pholder( $tplateOptns ){
    ...
    if( empty( $pImgUrlL ) ){ $pImgIDL = 0; }
        ...
        $pImgIDL = abcfsl_mbox_item_img_img_by_url( $pImgUrlL );
    }

    if( empty( $pImgUrlS ) ){ $pImgIDS = 0; }
    else {
        $pImgIDS = abcfsl_mbox_tplate_pholder_img_by_url( $pImgUrlS );
    }
...
function abcfsl_mbox_tplate_pholder_img_by_url( $url ){
